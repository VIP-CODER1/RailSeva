...
// Renders the public landing page and the top-level navigation links.
const Home = () => {
  // Loads translated strings and renders the landing page sections.
          ...
          <div className="row justify-content-around py-5">
            ...
            <div className="col-md-5 contact-box">
              <div className="general-box text-center p-4">
                ...
                <h4 className="general-email text-primary">support@railseva.in</h4>
